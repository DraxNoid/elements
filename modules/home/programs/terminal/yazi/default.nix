        ...
        programs.yazi = {
            ...
            keymap = {
                mgr.prepend_keymap = [
                    ...
                    #   -> cwd = /run/user/gvfs/DEVICE_1/FOLDER_A
                    #   -> device mountpoint = /run/user/1000/gvfs/DEVICE_1
                    #   -> remount this DEVICE_1 if needed
                    ...
                    #   -> Read more about the schemes here: https://wiki.gnome.org/Projects/gvfs/schemes.html
                    ...
                    #           - SSH, FTP, FTP(s), AFC, DNS_SD now support [/share]. For example: sftp://user@192.168.1.2/home/user_name -> /share = /home/user_name
